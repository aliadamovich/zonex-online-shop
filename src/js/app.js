...
// 				addButton(categoryChosen, spanText.textContent);
...
// 			}
// 		}
// 	// removeB(categoryChosen, closest, spanText.textContent, checkedInput);
// 	})


// //удаление выбранных категорий по нажатию на крестик и кнопку clear
// categoryChosen.addEventListener('click', removeButton);
